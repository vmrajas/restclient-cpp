...
class Connection {
 public:
    ...
    /**
      ...
      *  @var Info::allowInsecure
      *  Member 'allowInsecure' contains boolean. Set to true if you want
      *  to proceed without verifying certificate
    ...
    // set value of allowInsecure variable
    void SetAllowInsecure(bool allowInsecure);
